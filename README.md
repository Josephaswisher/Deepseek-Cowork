...
```bash
# Install CLI tool globally (latest version: 0.1.9)
npm install -g deepseek-cowork@0.1.9
...
> **CLI Version**: `deepseek-cowork@0.1.9`
...
The project uses semantic versioning (SemVer). Current version: **V0.1.9**
