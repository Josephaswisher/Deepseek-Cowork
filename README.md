...
<p align="center">
  ...
  <a href="https://github.com/imjszhang/deepseek-cowork">
    <img src="https://img.shields.io/badge/Version-0.1.34-blue.svg?style=flat-square" alt="Version" />
  </a>
...
```bash
# Install CLI tool globally (latest version: 0.1.34)
npm install -g deepseek-cowork@0.1.34
...
> **CLI Version**: `deepseek-cowork@0.1.34`
...
The project uses semantic versioning (SemVer). Current version: **V0.1.34**
