...
<p align="center">
  ...
  <a href="https://github.com/imjszhang/deepseek-cowork">
    <img src="https://img.shields.io/badge/Version-0.1.31-blue.svg?style=flat-square" alt="Version" />
  </a>
...
```bash
# Install CLI tool globally (latest version: 0.1.31)
npm install -g deepseek-cowork@0.1.31
...
> **CLI Version**: `deepseek-cowork@0.1.31`
...
The project uses semantic versioning (SemVer). Current version: **V0.1.31**
