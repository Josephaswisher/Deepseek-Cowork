...
const defaults = {
    ...
    // 失败日志文件名
    FAILURE_LOG_FILE_NAME: '.happy-failures.json',
    
    // 失败日志最大条目数
    FAILURE_LOG_MAX_ENTRIES: 100,
...
class Config {
    ...
    get FAILURE_LOG_FILE_NAME() { return this._config.FAILURE_LOG_FILE_NAME; }
    get FAILURE_LOG_MAX_ENTRIES() { return this._config.FAILURE_LOG_MAX_ENTRIES; }
